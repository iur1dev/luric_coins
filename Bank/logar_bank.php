...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($_POST['email'])) {
        ...
        $sql = "SELECT * FROM usuarios_bank where email = '$email' AND senha = '$senha'";
        ...
        if ($qnt == 1) {
            ...
            header("Location: index_bank.php");
        } else {
...
<body>
    <div>
        <a href="index_bank.php"><i class="fa-solid fa-circle-left text-light p-3" style="font-size: 60px;"></i></a>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <form method="POST" class="bg-light rounded p-3" style="margin-top: 50%;">
                    ...
                    <div class="mb-2">
                        <a href="usuarios_bank.php" class="text-dark"><small>Não tem conta ? clica aqui</small></a>
                    </div>
