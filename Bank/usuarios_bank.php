...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (
        ...
        if ($qnt_email == 1) {
            ...
            // cadastro
            $sql = "INSERT INTO usuarios_bank(email, senha, celular, nome, cpf, nasc, cep, estado, cidade, bairro, rua, numero)
...
<body>
    <div>
        <a href="logar_bank.php"><i class="fa-solid fa-circle-left text-light p-3" style="font-size: 60px;"></i></a>
    </div>
    <div class="container">
