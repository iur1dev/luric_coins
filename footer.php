...
<footer>
    ...
    <div class="container">
        <div class="row">
            <div class="col-3">
                ...
                <a href="" class="text-decoration-none"><small class="text-dark">Quem Somos</small><br></a>
                <a href="" class="text-decoration-none"><small class="text-dark">Depoimentos</small><br></a>
                <a href="" class="text-decoration-none"><small class="text-dark">FAQ</small><br></a>
                <a href="" class="text-decoration-none"><small class="text-dark">Politicas de entrega</small><br></a>
                <a href="" class="text-decoration-none"><small class="text-dark">Politicas e termos de Uso</small><br></a>
                <a href="" class="text-decoration-none"><small class="text-dark">Entre em contato</small></a>
            </div>
            <div class="col-3">
                <h3 class="text-danger fw-bold">Minha Conta</h3>
                <a href="" class="text-decoration-none"><small class="text-dark">Minha conta</small><br></a>
                <a href="" class="text-decoration-none"><small class="text-dark">Historico e pedidos</small><br></a>
                <a href="" class="text-decoration-none"><small class="text-dark">informativo</small></a>
                <h3 class="text-danger fw-bold mt-2">MARKETING</h3>
                <a href="" class="text-decoration-none"><small class="text-dark">Compre com tibia coins</small><br></a>
                <a href="" class="text-decoration-none"><small class="text-dark">Venda seus tibia coins</small></a>
            </div>
            <div class="col-3">
    ...
    <a href="index.php" class="text-muted fixed-bottom ms-2 fw-bold text-decoration-none">By Luric</a>
</footer>